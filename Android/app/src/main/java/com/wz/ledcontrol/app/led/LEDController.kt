package com.wz.ledcontrol.app.led

import WZBLECallback
import android.bluetooth.BluetoothDevice
import android.content.Context
import com.wz.ledcontrol.app.ble.WZBLEController
import com.wz.ledcontrol.app.ble.WZBluetoothUtil
import com.wz.ledcontrol.app.utils.LED_CHARACTERISTIC_BRIGHTNESS_UUID
import com.wz.ledcontrol.app.utils.LED_CHARACTERISTIC_DRAW_NORMAL_UUID
import com.wz.ledcontrol.app.utils.LED_CHARACTERISTIC_FILL_PIXEL_UUID
import com.wz.ledcontrol.app.utils.LED_CHARACTERISTIC_FILL_SCREEN_UUID
import com.wz.ledcontrol.app.utils.LED_CHARACTERISTIC_GIF_UUID
import com.wz.ledcontrol.app.utils.LED_CHARACTERISTIC_TEXT_SCROLL_UUID
import com.wz.ledcontrol.app.utils.LED_CHARACTERISTIC_TEXT_UUID
import com.wz.ledcontrol.app.utils.LED_DEFAULT_BRIGHTNESS
import com.wz.ledcontrol.app.utils.LED_DEFAULT_DISPLAY_TEXT
import com.wz.ledcontrol.app.utils.LED_MINIMUM_BRIGHTNESS
...
import com.wz.ledcontrol.app.utils.LED_CHARACTERISTIC_REFRESH_RATE_UUID
...
class LEDController private constructor() {
    ...
    private lateinit var mBLEController: WZBLEController
    ...
    fun initBLE(context: Context) {
        if (!isInitialized) {
            ...
            // 创建BLE控制器（不再需要传入设备地址）
            mBLEController = WZBLEController(
    ...
    fun connect(callback: WZBLECallback) {
        ...
        mBLEController.connect(object : WZBLECallback by callback {
            override fun onConnected(name: String?, address: String?) {
                ...
                if (address != null) {
                    // 注意：这里不再直接保存，因为WZBLEController会处理配对和保存
                    logd("设备连接成功，配对状态将由WZBLEController管理")
                }
